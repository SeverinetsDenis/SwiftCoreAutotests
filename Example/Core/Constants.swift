...
struct iOSHelper {
     ...
     */
    static func inputNumber(_ number: Double) {
        for ch in Array(String(number)) {
            Container.app.buttons[String(ch)].tap()
        }
    }
...
//    static private func doAction(remoteButton: XCUIRemote.Button, count: Int) -> Void {
//        for _ in 1...count{
...
//        doAction(remoteButton: XCUIRemote.Button.up, count: count)
//    }
//
//    static func goDown(count: Int = 1) -> Void {
//        doAction(remoteButton: XCUIRemote.Button.down, count: count)
//    }
//
//    static func goLeft(count: Int = 1) -> Void {
//        doAction(remoteButton: XCUIRemote.Button.left, count: count)
//    }
//
//    static func goRight(count: Int = 1) -> Void {
//        doAction(remoteButton: XCUIRemote.Button.right, count: count)
//    }
...
/**
 Localized extension allows doesn't care about translations for an elements
 */
extension String {
